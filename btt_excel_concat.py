...
'''
    Konsolidierung Worksheets
        - Übersicht in [A:B] und [E:H]
        - Quercheck Transaktionen entfällt
        - BTT, Formulare, Schnittstellen werden im Gesamten konsolidiert
        - BPML in [A:D] und [F:J]
        - Datengrundlage adesso zunächst ignoriert, da immer gleich???
'''
